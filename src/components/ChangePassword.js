                    ...
                    <div className="container ">
                        <form onSubmit={changePasswordHandler}>
                            ...
                            <div className="row no-gutters">
                                ...
                                <div className="col-4" style={{padding: "0px 10px"}}><button disabled={disableBtn} className="btn btn-primary text-center" style={{backgroundColor:buttonColor, fontSize:"calc(2px + 2vmin)", width:"100%", padding: "0px 0px !important"}}>Update</button></div>
                            </div>
                        </form>
                    </div> 
                </div>
