...
function RegistrationForm(){
    ...
    const validateAndUpdateUserName = (event) => {
    ...
    const submit = () =>{
        ...
        let object = {
            ...
            "signupEnableToggle":signupEnableToggle,
        }
        console.log(object);
    }
...
{/* Start */}
                                ...
                                <div className="col-12 form-group"><button id="register_btn" className="col-8 offset-2 btn btn-primary btn-block" type="submit" disabled={true}>Register</button></div>
