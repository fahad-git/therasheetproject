...
import completed_exercise_patient_icon from '../assets/img/active_patient_icon.png';
import pending_exercise_patient_icon from '../assets/img/all_patient_icon.png';
...
import getClinicianBoard from '../services/clinician.service';
import getPatientsDataByDate from '../services/clinician.service';
...
/*
    ...
    */
    ...
    var [dropDownValue, setDropDownValue] = useState("Today's Patients")
    ...
    const patientInfoHandler = (patientId, status) =>{
        setParams([patientId, status]);
                        ...
                        <div className="card-body float-left">
                            <div className="row justify-content-left">
                                ...
                                <div className="dropdown">
                                    <select className="btn btn-primary dropdown-toggle" type="button" onChange={patientSelectHandler} style={{backgroundColor:background_color, maxWidth: "200px", width:"200px", maxHeight: "70px", height:"40px", border:"0px", outline:"none", fontSize:"16px"}}>
                                        ...
                                        <option className="dropoptions" value="All Patients">All Patients</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className="row justify-content-left">
                                <div className="col-12 col-sm-5 col-md-5 col-lg-6">
                                    ...
                                    <input type="radio" name="filter" value="Completed" onClick = {radioButtonHandler}/>
                                    <label className="radio-buttons" htmlFor="Completed">Completed</label>

                                    <input type="radio" name="filter" value="Pending" onClick = {radioButtonHandler}/>
                                    <label className="radio-buttons" htmlFor="Pending">Pending</label>
                                   
                                </div>
                        

                                <div className="col-10 offset-2 col-sm-5 col-md-5 col-lg-4">
                                    {/* // this renders the full component (input and datepicker) */}
                                    <DatePickerInput className="col-12"
                                    onChange={onchange}
                                    value={selectedDate}
                            ...
                            <div className="row justify-content-center align-items-center top-buffer" style={{marginTop:"100px"}}>
                                <div className="col-12">
                                    {patientInformation.map( ({patientname, patientId, status}, index)=>{
                                    return (
                                            <div key={index} className="col-6 col-sm-4 col-md-3 col-lg-2 offset-0" style={{float:"left", marginTop:"20px"}} onClick={() => patientInfoHandler(patientId, status)}>
                                                <div className="card tile" >
                                                    <img alt="Not found" className="clinicicon" src={(status === "Completed") ? completed_exercise_patient_icon : pending_exercise_patient_icon } />
                                                </div>                                                                  
